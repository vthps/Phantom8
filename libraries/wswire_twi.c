...
#include <util/twi.h>
#include "wswire_twi.h"
#include "../cores/Arduino.h" // for digitalWrite
...
#include "../cores/mega_pins_arduino.h"
...
void twi_init(void)
{
  ...
  //added by brooke: disable the twi module (to allow for reinitialize)
  TWCR = 0;
